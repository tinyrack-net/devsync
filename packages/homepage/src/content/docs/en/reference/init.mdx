...
<Aside type="tip">
If you pass a repository to `dotweave init`, you must also provide the existing age private key with `--key` or `--promptKey` so dotweave can decrypt your secret files.
</Aside>
