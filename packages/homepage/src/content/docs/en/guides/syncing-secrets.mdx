...
Your age key is created automatically during `devsync init`. If this is your first machine, just press Enter when prompted — a new key pair will be generated.
...
2. Pull the files:
   ...
   Secret files are automatically decrypted and written to their local paths.
