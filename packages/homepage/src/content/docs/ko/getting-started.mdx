...
Windows에서는 Microsoft Store 등록이 공개된 뒤 Store에서 설치하세요. 수동으로
사용할 수 있는 portable Windows `.exe` 파일은 GitHub Releases에 계속
첨부돼요.

macOS, Linux, WSL 또는 cross-platform fallback으로는 npm을 사용할 수 있어요:
